    ...
    return (
        <div className="relative overflow-hidden">
            <div className="bg-secondary border border-white/10 p-12 md:p-20 relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 items-center text-left">
                    <div className="lg:w-1/2">
                        <h2 className="text-4xl md:text-6xl font-black uppercase italic leading-[0.9] tracking-tighter mb-8 text-white">
                            Receba Nossa <br />
                            <span className="text-primary italic">Grade de Horários</span> <br />
                            e Tabela de Preços
                        </h2>
                        <p className="text-lg md:text-xl text-white/60 uppercase font-medium max-w-md">
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            <div>
                                <input
                                    ...
                                    className="w-full bg-background border-2 border-white/10 p-5 font-bold uppercase focus:border-primary text-white placeholder:text-white/20 outline-none transition-colors"
                                />
                            </div>
                            <div>
                                <input
            ...
            <div className="absolute top-1/2 left-0 -translate-y-1/2 opacity-[0.02] pointer-events-none select-none">
                <span className="text-[20rem] md:text-[30rem] font-black uppercase italic leading-none -ml-20 text-white">PRICES</span>
            </div>
        </div>
    );
}
